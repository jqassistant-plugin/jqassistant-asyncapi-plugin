...
public abstract class KafkaChannelBindingsMapperDecorator extends AbstractReferenceObjectMapperDecorator<KafkaChannelBinding, KafkaChannelBindingsDescriptor>
        implements KafkaChannelBindingsMapper {

    protected KafkaChannelBindingsMapperDecorator(KafkaChannelBindingsMapper mapper) {
