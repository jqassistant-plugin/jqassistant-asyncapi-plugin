...
import org.jqassistant.plugin.asyncapi.impl.mapper.decorator.ComponentsCorrelationIdMapperDecorator;
import org.jqassistant.plugin.asyncapi.impl.mapper.service.ReferenceableObjectMapper;
import org.mapstruct.*;

@Mapper
@DecoratedWith(ComponentsCorrelationIdMapperDecorator.class)
public interface ComponentsCorrelationIdMapper extends ReferenceableObjectMapper<CorrelationID, CorrelationIDDescriptor> {
