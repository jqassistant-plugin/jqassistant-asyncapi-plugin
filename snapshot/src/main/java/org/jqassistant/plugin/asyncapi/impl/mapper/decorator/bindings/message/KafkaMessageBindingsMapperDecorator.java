...
public abstract class KafkaMessageBindingsMapperDecorator extends AbstractReferenceObjectMapperDecorator<KafkaMessageBinding, KafkaMessageBindingsDescriptor>
        implements KafkaMessageBindingsMapper {

    protected KafkaMessageBindingsMapperDecorator(KafkaMessageBindingsMapper mapper) {
